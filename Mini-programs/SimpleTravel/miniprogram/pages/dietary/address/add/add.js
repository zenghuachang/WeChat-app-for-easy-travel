...
Page({
    ...
    getAddress: function (area) { //获取地址
        // 选择poi地址回调
        that.setData({
            area: area
        });
    },
    add: function (e) { //新增编辑地址信息
    ...
    loadAddress: function (objectId) {    //加载出已经存在的地址信息
        var query = new Bmob.Query('Address');
        //console.log(objectId);//获取到数据库Address里的objectId字段
