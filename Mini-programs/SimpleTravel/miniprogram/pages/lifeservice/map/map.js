// 引用百度地图微信小程序JSAPI模块 
var bmap = require('../../../utils/lifeservice/bmap-wx.js');
var wxMarkerData = [];
Page({
  data: {
    markers: [],
  ...
  onLoad: function () {
    ...
    var BMap = new bmap.BMapWX({
      ak: '7nPR9Gtr8DH19ONBIhBO1ZdHizT1reRK'
    });
    that.setData({
      bitmap: BMap
    });
  ...
  changeMarkerColor: function (data, id) {
    ...
    for (var i = 0; i < data.length; i++) {
      if (i === id) {
        data[i].iconPath = "../../../images/lifeservice/marker_blue.png";
      } else {
        data[i].iconPath = "../../../images/lifeservice/marker_red.png";
      }
  ...
  onShow: function () {
    ...
    this.data.bitmap.search({
      ...
      // 此处需要在相应路径放置图片文件 
      iconPath: '../../../images/lifeservice/marker_red.png',
      // 此处需要在相应路径放置图片文件 
      iconTapPath: '../../../images/lifeservice/marker_red.png'
    });
  },
